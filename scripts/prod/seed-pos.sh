...
# passwords to Kopitiam57-kasir. Do not re-run on a live till — that
# updateOrCreates catalog rows. Rotate hashes only with:
...
yellow "  rina@kopitiam57.test, dewi@kopitiam57.test / Kopitiam57-kasir"
...
echo "SEED_POS_OK — demo password is Kopitiam57-kasir (shared; change before a real till)"
REMOTE
