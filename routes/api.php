...
use App\Http\Controllers\Api\V1\EmployeeExpenseController;
...
use App\Http\Controllers\Api\V1\FollowUpLevelController;
...
Route::prefix('v1')->group(function () {
    ...
    */
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::apiResource('follow-up-levels', FollowUpLevelController::class);
        Route::apiResource('employee-expenses', EmployeeExpenseController::class);
        Route::post('employee-expenses/{employeeExpense}/submit', [EmployeeExpenseController::class, 'submit']);
        Route::post('employee-expenses/{employeeExpense}/approve', [EmployeeExpenseController::class, 'approve']);
        Route::post('employee-expenses/{employeeExpense}/refuse', [EmployeeExpenseController::class, 'refuse']);
        Route::post('employee-expenses/{employeeExpense}/post', [EmployeeExpenseController::class, 'post']);
        Route::post('employee-expenses/{employeeExpense}/cancel', [EmployeeExpenseController::class, 'cancel']);
