...
class ChartOfAccountsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $accounts = [
            ...
            ['code' => '1-1700', 'name' => 'Uang Muka Pembelian', 'type' => Account::TYPE_ASSET, 'subtype' => Account::SUBTYPE_CURRENT_ASSET, 'is_system' => true, 'parent' => '1-1000'],
            ...
            ['code' => '2-1700', 'name' => 'Uang Muka Penjualan', 'type' => Account::TYPE_LIABILITY, 'subtype' => Account::SUBTYPE_CURRENT_LIABILITY, 'is_system' => true, 'parent' => '2-1000'],
