...
class PaymentFactory extends Factory
{
    ...
    public function forInvoice(\App\Models\Sales\Invoice $invoice): static
    {
        return $this->state(fn (array $attributes) => [
            'type' => Payment::TYPE_RECEIVE,
            'contact_id' => $invoice->contact_id,
            'payable_type' => \App\Models\Sales\Invoice::class,
            'payable_id' => $invoice->id,
        ]);
    }

    public function forBill(\App\Models\Purchasing\Bill $bill): static
    {
        return $this->state(fn (array $attributes) => [
            'type' => Payment::TYPE_SEND,
            'contact_id' => $bill->contact_id,
            'payable_type' => \App\Models\Purchasing\Bill::class,
            'payable_id' => $bill->id,
        ]);
    }
}
