...
class MrpRun extends Model
{
    ...
    {
        return $this->status === DocumentStatus::Applied;
    }
    ...
    {
        return in_array($this->status, [DocumentStatus::Draft, DocumentStatus::Completed], true);
    }
    ...
    {
        return collect(DocumentStatus::forMrpRun())
