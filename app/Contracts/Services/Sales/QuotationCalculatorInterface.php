...
interface QuotationCalculatorInterface
{
    /**
     * Calculate quotation totals from items data.
     *
     ...
     * @return \App\Domain\Sales\Quotations\QuotationTotals Calculated totals
     */
    public function calculate(
        ...
        string $currency,
        float $exchangeRate
    ): \App\Domain\Sales\Quotations\QuotationTotals;
}
