...
class BomService implements BomServiceInterface
{
    ...
    public function getStatistics(): array
    {
        return [
            ...
            'draft_count' => Bom::where('status', DocumentStatus::Draft)->count(),
            'active_count' => Bom::where('status', DocumentStatus::Active)->count(),
            'inactive_count' => Bom::where('status', DocumentStatus::Inactive)->count(),
            'products_with_bom' => Bom::where('status', DocumentStatus::Active)
                ->distinct('product_id')
                ->count('product_id'),
            'avg_material_cost' => (int) Bom::where('status', DocumentStatus::Active)
