...
class SeedDemoCommand extends Command
{
    ...
    protected $signature = 'seed:demo
                            {--demo= : Which demo to seed (vahana, nex, all)}
     ...
     * @var string
     */
    protected $description = 'Seed demo data with optional selection of Vahana, NEX, or both';
    ...
    public function handle(): int
    {
        ...
        if ($demo && ! in_array($demo, [DemoSeeder::DEMO_VAHANA, DemoSeeder::DEMO_NEX, DemoSeeder::DEMO_ALL])) {
            $this->error("Invalid demo option: {$demo}");
            $this->info('Valid options: vahana, nex, all');
        ...
        if (! $demo) {
            ...
            $demo = $this->choice(
                ...
                [
                    ...
                    DemoSeeder::DEMO_ALL => '🔄 Both - Vahana + NEX (full demo)',
                ],
                DemoSeeder::DEMO_ALL
            );
        }
