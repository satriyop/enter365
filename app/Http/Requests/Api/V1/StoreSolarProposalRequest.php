...
class StoreSolarProposalRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            // Solar Data (usually auto-filled from location)
            ...
            // System Selection
            'variant_group_id' => ['nullable', 'exists:bom_variant_groups,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'roof_tilt_degrees.max' => 'Kemiringan atap maksimal 90 derajat.',
            'shading_percentage.max' => 'Persentase shading maksimal 100%.',
            'monthly_consumption_kwh.min' => 'Konsumsi bulanan tidak boleh negatif.',
