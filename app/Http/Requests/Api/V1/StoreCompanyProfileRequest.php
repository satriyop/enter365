...
class StoreCompanyProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:100', 'unique:company_profiles,slug', 'regex:/^[a-z0-9-]+$/'],
            ...
            'cover_image' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp', 'max:5120'], // 5MB max
            ...
            // Custom domain
            'custom_domain' => ['nullable', 'string', 'max:100', 'unique:company_profiles,custom_domain'],
