...
class FiscalPeriodResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_open' => $this->isOpen(),
            'lock_sales_until' => $this->lock_sales_until?->toDateString(),
            'lock_purchases_until' => $this->lock_purchases_until?->toDateString(),
            'lock_tax_until' => $this->lock_tax_until?->toDateString(),
            'lock_everything_until' => $this->lock_everything_until?->toDateString(),
            'hard_lock_until' => $this->hard_lock_until?->toDateString(),
